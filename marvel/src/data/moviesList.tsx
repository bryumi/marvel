export const moviesList = [
    {
        id: 21, 
        photo: '../../public/img/movies/homem-de-ferro.svg',
    ...
    {
        id: 22, 
        photo: '../../public/img/movies/homem-de-ferro-2.svg',
        title:'Homem de Ferro 2',
        text:'O mundo já sabe que o inventor bilionário Tony Stark (Robert Downey Jr.) é o super-herói blindado Homem de Ferro. Sofrendo pressão do governo, da mídia e do público para compartilhar sua tecnologia com as forças armadas'
    },
    {
        id: 23, 
        photo: '../../public/img/movies/thor.svg',
        title:'Thor',
    ...
    {
        id: 24, 
        photo: '../../public/img/movies/capitao-america.svg',
    ...
    {
        id: 25, 
        photo: '../../public/img/movies/capita-marvel.svg',
        title:'Capitã Marvel',
